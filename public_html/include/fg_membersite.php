...
class FGMembersite
{
    ...
    {
        $this->sitename = 'ihsassassin.netii.net';
    ...
    //function UserTarget()
    //{
    //    return ($_SESSION['target_of_user'])?$_SESSION['target_of_user']:'';
    //}
    //$_SESSION['target_of_user']

    //function UserTarget($name)
    //{
    //    $servername = 'localhost';
    //    $username = 'id854024_assassin';
    //    $password = 'codeclub';
    ...
    //    }
    //    $end = msql_query("Select target from Students where name='$name'", $conn);
    //    return end;
    //}

    //function UserTarget()
    //{
    //    return mysqli_query(mysqli_connect('localhost','id854024_assassin','codeclub','id854024_studentdirectory'), "Select target from $this->tablename where username='$username' and password='$pwdmd5'");
    //}
